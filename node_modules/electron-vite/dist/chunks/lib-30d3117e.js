...
const _require$1 = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('chunks/lib-30d3117e.js', document.baseURI).href)));
    ...
    return [
        {
            ...
            config(config) {
                ...
                if ((_a = config.build) === null || _a === void 0 ? void 0 : _a.outDir) {
...
const _require = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('chunks/lib-30d3117e.js', document.baseURI).href)));

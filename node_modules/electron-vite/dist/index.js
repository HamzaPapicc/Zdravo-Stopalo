...
var config = require('./chunks/lib-30d3117e.js');
var server = require('./chunks/lib-3fb7872b.js');
var build = require('./chunks/lib-0b6fdb51.js');
var preview = require('./chunks/lib-654921af.js');
...
const _require = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('index.js', document.baseURI).href)));
...
function bytecodePlugin(options = {}) {
    ...
    return {
        ...
        configResolved(resolvedConfig) {
            ...
            if (useInRenderer) {
                config$1.logger.warn(colors.yellow('bytecodePlugin is not support renderers'));
            }
        },
        transform(code, id) {
            ...
            if (s) {
                return {
                    code: s.toString(),
                    map: config$1.build.sourcemap ? s.generateMap({ hires: true }) : null
                };
            }
        },
